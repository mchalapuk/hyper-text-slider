  ...
  describe('constructed with a slider containing one slide', function() {
    ...
    describe('after upgrading the slide,', function() {
      ...
      it('then slide contains default transition class', function() {
        expect(testedElement.childNodes[0].classList.contains(Transition.ZOOM_IN_OUT)).toBe(true);
      });
      it('then slide contains default theme class', function() {
    ...
    describe('after calling start,', function() {
      ...
      describe('and upgrading all slides,', function() {
        ...
        it('no slide contains default transition', function() {
          expect(testedElement.childNodes[0].classList.contains(Transition.ZOOM_IN_OUT)).toBe(false);
          expect(testedElement.childNodes[1].classList.contains(Transition.ZOOM_IN_OUT)).toBe(false);
        });
