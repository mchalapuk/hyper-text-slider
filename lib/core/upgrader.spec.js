...
describe('upgrader,', function() {
  ...
  describe('with one slide containing "hermes-theme--default-controls"', function() {
    var testedElement = null;
    var testedUpgrader = null;
    beforeEach(function() {
      testedElement = createElement();
      testedElement.appendChild(createElement(Theme.DEFAULT_CONTROLS));
      testedUpgrader = upgrader(testedElement);
    });
    ...
    describe('when after calling #start', function() {
      ...
      expectedThemes.forEach(function(className) {
