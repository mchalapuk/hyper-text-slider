...
describe('slider', function() {
  ...
  describe('with 3 slides', function() {
    ...
    describe('when after calling #start', function() {
      ...
      describe('and after sending first animationStart event', function() {
        beforeEach(function() {
          sliderElement.childNodes[0].dispatchEvent(
              new AnimationEvent('animationstart', 'htSlideInserted'));
        });
      ...
      describe('and after upgrading first slide', function() {
        ...
        it('then contains "ht-slide-id-first" class', function() {
          expect(sliderElement.classList.contains('ht-slide-id-first')).toBe(true);
        });

        it('slide contains "ht-layout--background" element as first child', function() {
          expect(testedSlider.slides[0].childNodes[0].classList.contains(Layout.BACKGROUND)).toBe(true);
        });
        it('slides contains "ht-layout--content" element as second child', function() {
          expect(testedSlider.slides[0].childNodes[1].classList.contains(Layout.CONTENT)).toBe(true);
        });

        it('then contains first slide with "ht-slide-to" flag', function() {
          expect(testedSlider.slides[0].classList.contains('ht-slide-to')).toBe(true);
        });

        it('then contains "ht-before-transition" class', function() {
    ...
    describe('when after setting current slide to 1', function() {
      ...
      it('then contains "ht-before-transition" class', function() {
        expect(sliderElement.classList.contains('ht-before-transition')).toBe(true);
      });
      it('then does not contain "ht-slide-id-first" class', function() {
        expect(sliderElement.classList.contains('ht-slide-id-first')).toBe(false);
      });
      it('then contains "ht-slide-id-second" class', function() {
        expect(sliderElement.classList.contains('ht-slide-id-second')).toBe(true);
      });

      describe('after firing transitionend event on current slide element', function() {
        beforeEach(function() {
          var target = testedSlider.currentSlide.querySelector('.ht-layout--content');
          var event = new TransitionEvent('transitionend', target, 'transform');
          target.dispatchEvent(event);
        });

        it('then slider moves to "ht-during-transition" phase', function() {
          expect(sliderElement.classList.contains('ht-during-transition')).toBe(true);
        });
        ...
        describe('and after firing transitionend event second time', function() {
          ...
          it('then slider moves to "ht-after-transition" phase', function() {
            expect(sliderElement.classList.contains('ht-after-transition')).toBe(true);
          });
        });
      });
    });
  ...
  describe('with one slide with ht-theme--black', function() {
    var sliderElement = null;
    var testedSlider = null;
  ...
  describe('with "ht-theme--test" class,', function() {
    describe('and 2 slides, one with "ht-theme--test2" and "ht-theme-test3" class', function() {
      var sliderElement = null;
      var testedSlider = null;

      beforeEach(function() {
        sliderElement = createSliderElement(3);
        sliderElement.classList.add('ht-theme--test');
        sliderElement.childNodes[1].classList.add('ht-theme--test2');
        sliderElement.childNodes[1].classList.add('ht-theme--test3');
        testedSlider = slider(sliderElement);
      });
      ...
      describe('and after upgrading first slide', function() {
        ...
        it('then slider contains "ht-theme--test" class', function() {
          expect(sliderElement.classList.contains('ht-theme--test')).toBe(true);
        });
      });
      ...
      describe('when after setting current slide to 1', function() {
        ...
        it('then slider doesn\'t contain "ht-theme--test" class', function() {
          expect(sliderElement.classList.contains('ht-theme--test')).toBe(false);
        });
        it('then slider contains both theme class names from the slide', function() {
          expect(sliderElement.classList.contains('ht-theme--test2')).toBe(true);
          expect(sliderElement.classList.contains('ht-theme--test3')).toBe(true);
        });
      });
    });
  });

  describe('with "ht-transition--test" class,', function() {
    describe('and 2 slides, one with "ht-transition--test2" and "ht-transition-test3" class', function() {
      var sliderElement = null;
      var testedSlider = null;

      beforeEach(function() {
        sliderElement = createSliderElement(3);
        sliderElement.classList.add('ht-transition--test');
        sliderElement.childNodes[1].classList.add('ht-transition--test2');
        sliderElement.childNodes[1].classList.add('ht-transition--test3');
        testedSlider = slider(sliderElement);
      });
      ...
      describe('and after upgrading first slide', function() {
        ...
        it('then slider contains "ht-transition--test" class', function() {
          expect(sliderElement.classList.contains('ht-transition--test')).toBe(true);
        });
      });
      ...
      describe('when after setting current slide to 1', function() {
        ...
        it('then slider doesn\'t contain "ht-transition--test" class', function() {
          expect(sliderElement.classList.contains('ht-transition--test')).toBe(false);
        });
        it('then slider contains both transition class names from the slide', function() {
          expect(sliderElement.classList.contains('ht-transition--test2')).toBe(true);
          expect(sliderElement.classList.contains('ht-transition--test3')).toBe(true);
        });
      });
    });
  });
  ...
  describe('with "'+ Option.AUTOPLAY +'" flag', function() {
    ...
    describe('when after starting and firing transitionend event twice', function() {
      ...
      it('then slider is in "ht-before-transition" phase', function() {
        expect(sliderElement.classList.contains('ht-before-transition')).toBe(true);
      });
    });
  });
  ...
  describe('with 3 slides', function() {
    ...
    describe('when after calling #start', function() {
      ...
      describe('and after click event fired on left arrow', function() {
        beforeEach(function() {
          sliderElement.querySelector('.ht-layout--arrow-left')
        ...
        it('then is in "ht-before-transition" phase', function() {
          expect(sliderElement.classList.contains('ht-before-transition')).toBe(true);
        });
      });
      ...
      describe('and after click event fired on right arrow', function() {
        beforeEach(function() {
          sliderElement.querySelector('.ht-layout--arrow-right')
            .dispatchEvent(new MouseEvent('click'));
        });
  ...
  describe('with 2 slides', function() {
    ...
    describe('when just after calling #start', function() {
      ...
      describe('and after click event fired on second dot', function() {
        beforeEach(function() {
          sliderElement.querySelector('.ht-layout--dots').childNodes[1]
            .dispatchEvent(new MouseEvent('click'));
        });
