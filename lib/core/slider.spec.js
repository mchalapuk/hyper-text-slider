...
describe('slider', function() {
  ...
  describe('with 3 slides and "hermes-transition--test" class', function() {
    ...
    describe('when after calling #start', function() {
      ...
      describe('and after upgrading first slide', function() {
        ...
        it('then contains a theme class name from first slide', function() {
    ...
    describe('when after setting current slide to 1', function() {
      ...
      it('then contains a theme class name from second slide', function() {
  ...
  describe('with one side,', function() {
    ...
    describe('and after upgrading first slide', function() {
      ...
      it('then contains default transition class', function() {
        expect(sliderElement.classList.contains('hermes-transition--zoom-in-out')).toBe(true);
      });
    });
  });

  describe('with "hermes-transition--test" class,', function() {
    describe('and 2 slides, one with "hermes-transition-test2" class', function() {
      var sliderElement = null;
      var testedSlider = null;
      ...
      describe('when after setting current slide to 1', function() {
        ...
        it('then doesn\'t contain "hermes-transition--test" class', function() {
          expect(sliderElement.classList.contains('hermes-transition--test')).toBe(false);
        });
        it('then contains "hermes-transition--test2" class', function() {
